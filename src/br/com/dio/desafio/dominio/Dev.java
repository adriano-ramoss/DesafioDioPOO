...
public class Dev {
	...
	private String nome;
	private Set<Conteudo> conteudoInscritos = new  LinkedHashSet<>(); //Exemplo de Polimorfismo
	private Set<Conteudo> conteudosConcluidos = new LinkedHashSet<>();
	
	
	public void inscreverBootcamp(Bootcamp bootcamp) {
		this.conteudoInscritos.addAll(bootcamp.getConteudos());//Pegando tudo que tem em "bootcamp.getConteudos" e posicionando dentro de conteudoInscritos
